...
#include "vinylsettingsprovider.h"
...
K_PLUGIN_FACTORY_WITH_JSON(VinylDecoFactory, "vinyl.json", registerPlugin<Vinyl::Decoration>(); registerPlugin<Vinyl::Button>();)
...
{
    switch (size) {
    case Vinyl::InternalSettings::ShadowNone:
        return s_shadowParams[0];
    case Vinyl::InternalSettings::ShadowSmall:
        return s_shadowParams[1];
    case Vinyl::InternalSettings::ShadowMedium:
        return s_shadowParams[2];
    case Vinyl::InternalSettings::ShadowLarge:
        return s_shadowParams[3];
    case Vinyl::InternalSettings::ShadowVeryLarge:
        return s_shadowParams[4];
    default:
        // Fallback to the Small size.
        return s_shadowParams[1];
    }
}
...
{
    switch (intensity) {
    case Vinyl::InternalSettings::OutlineOff:
        return 0;
    case Vinyl::InternalSettings::OutlineLow:
        return Vinyl::Metrics::Bias_Default / 2;
    case Vinyl::InternalSettings::OutlineMedium:
        return Vinyl::Metrics::Bias_Default;
    case Vinyl::InternalSettings::OutlineHigh:
        return Vinyl::Metrics::Bias_Default * 2;
    case Vinyl::InternalSettings::OutlineMaximum:
        return Vinyl::Metrics::Bias_Default * 3;
    default:
        // Fallback to not outlined.
        return 0;
    }
}
}
...
static int g_shadowStrength = 77;
...
#endif
{
    ...
    // Linear to have the same easing as Vinyl animations
