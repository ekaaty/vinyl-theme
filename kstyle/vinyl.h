...
namespace Vinyl
{
    ...
    namespace PenWidth
    {
        /* Using 1 instead of svinyl more than 1 causes symbols drawn with
...
Q_DECLARE_OPERATORS_FOR_FLAGS( Vinyl::AnimationModes )
Q_DECLARE_OPERATORS_FOR_FLAGS( Vinyl::AnimationParameters )
Q_DECLARE_OPERATORS_FOR_FLAGS( Vinyl::Corners )
Q_DECLARE_OPERATORS_FOR_FLAGS( Vinyl::Sides )
