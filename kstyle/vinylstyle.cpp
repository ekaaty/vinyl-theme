...
#include "vinyl.h"
#include "vinylanimations.h"
#include "vinylframeshadow.h"
#include "vinylmdiwindowshadow.h"
#include "vinylmnemonics.h"
#include "vinylpropertynames.h"
#include "vinylshadowhelper.h"
#include "vinylsplitterproxy.h"
#include "vinylstyleconfigdata.h"
#include "vinylwidgetexplorer.h"
#include "vinylwindowmanager.h"
#include "vinylblurhelper.h"
...
namespace VinylPrivate
{
    ...
    class TabBarData: public QObject
    {
        ...
        Vinyl::WeakPointer<const QWidget> _tabBar;
    ...
    class ComboBoxItemDelegate: public QItemDelegate
    {
        ...
        explicit ComboBoxItemDelegate( QAbstractItemView* parent ):
            ...
            _itemMargin( Vinyl::Metrics::ItemView_ItemMarginWidth )
        {}
        ...
        //* proxy
        Vinyl::WeakPointer<QAbstractItemDelegate> _proxy;
...
namespace Vinyl
{
    ...
    Style::Style():
        ...
        , _tabBarData( new VinylPrivate::TabBarData( this ) )
        ...
        #endif
    {
        ...
        // use DBus connection to update on vinyl configuration change
    ...
    void Style::polish( QWidget* widget )
    {
        ...
        if( qobject_cast<QScrollBar*>( widget ) )
        {
            ...
            if( !hasParent( widget, "QWebView" ) )
            {
                ...
                { itemView->setItemDelegate( new VinylPrivate::ComboBoxItemDelegate( itemView ) ); }
            }
    ...
    void Style::unpolish( QWidget* widget )
    {
        ...
        if ( VinylPrivate::possibleTranslucentToolBars.contains( widget ) ) 
            VinylPrivate::possibleTranslucentToolBars.remove( widget );
                ...
                && widget->testAttribute( Qt::WA_TranslucentBackground ) )
            {
                switch ( widget->windowFlags() & Qt::WindowType_Mask ) {
                    ...
                    case Qt::Sheet: {
                        ...
                        {
                            if( VinylPrivate::possibleTranslucentToolBars.size() == 1 )
                            {
                                QSet<const QWidget *>::const_iterator i = VinylPrivate::possibleTranslucentToolBars.constBegin();
    ...
    QRect Style::progressBarGrooveRect( const QStyleOption* option, const QWidget* widget ) const
    {
        ...
        const bool horizontal( VinylPrivate::isProgressBarHorizontal( progressBarOption ) );
    ...
    bool Style::drawMenuBarEmptyAreaControl( const QStyleOption* option, QPainter* painter, const QWidget* widget) const
    {
        ...
        if ( VinylPrivate::possibleTranslucentToolBars.isEmpty() ) shouldDrawShadow = true;
    ...
    bool Style::drawMenuBarItemControl( const QStyleOption* option, QPainter* painter, const QWidget* widget) const
    {
        ...
        if ( widget && _helper->titleBarColor( windowActive ).alphaF()*100.0 < 100 && _translucentWidgets.contains( widget->window() ) )
        {
            ...
            else if ( VinylPrivate::possibleTranslucentToolBars.size() == 1 )
            {
                QSet<const QWidget *>::const_iterator i = VinylPrivate::possibleTranslucentToolBars.constBegin();
                const QToolBar *tb = qobject_cast<const QToolBar*>( *i );
    ...
    */
    ...
    bool Style::isStylableToolbar(const QWidget* w, bool allowInvisible) const  //should be in helper
    {
        ...
        if (QMainWindow *mw = qobject_cast<QMainWindow*>(p))
        {
            ...
            {   
                if( tb->y() == 0 ) {
                    if ( VinylPrivate::possibleTranslucentToolBars.size() == 0 ) {
                        VinylPrivate::possibleTranslucentToolBars.insert( w );
                        return true;
                    }
                    else if ( VinylPrivate::possibleTranslucentToolBars.contains( w ) && VinylPrivate::possibleTranslucentToolBars.size() == 1 ) 
                        return true;
